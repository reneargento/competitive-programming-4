...
public class Exercise3 {
    ...
    private static int countMinimumIncreasingSubsequences(int[] sequence) {
        return longestNonIncreasingSubsequenceSize(sequence);
    }

    private static int longestNonIncreasingSubsequenceSize(int[] array) {
