...
public class TightWordsUVa {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            outputWriter.printLine(String.format("%.5f", tightWordsPercentage));
    ...
    private static BigDecimal computeTightWordsPercentage(int maxDigit, int length) {
        ...
        return tightWords.multiply(BigDecimal.valueOf(100)).divide(totalWords, 6, RoundingMode.DOWN);
    }
