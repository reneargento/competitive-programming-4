...
public class HeavyCycleEdges {
    ...
    private static class KruskalMinimumSpanningTree {
        ...
        public static List<Integer> getHeavyCycleWeights(List<Edge> edges, int totalVertices) {
            List<Integer> heavyCycleWeights = new ArrayList<>();
            ...
            for (Edge edge : edges) {
                if (!unionFind.connected(edge.vertex1, edge.vertex2)) {
                    ...
                    heavyCycleWeights.add(edge.cost);
                }
            ...
            Collections.sort(heavyCycleWeights);
            return heavyCycleWeights;
        }
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (nodes != 0 || edges != 0) {
            ...
            List<Integer> heavyCycleWeights = KruskalMinimumSpanningTree.getHeavyCycleWeights(edgesList, nodes);
            if (heavyCycleWeights.isEmpty()) {
                outputWriter.printLine("forest");
            } else {
                outputWriter.print(heavyCycleWeights.get(0));
                for (int i = 1; i < heavyCycleWeights.size(); i++) {
                    outputWriter.print(" " + heavyCycleWeights.get(i));
                }
