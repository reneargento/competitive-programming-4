...
/**
 * Created by Rene Argento on 15/09/23.
 */
public class RACING {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int t = 0; t < tests; t++) {
            ...
            for (int i = 0; i < roads; i++) {
                ...
                edges.add(new Edge(junctionID1, junctionID2, cost));
            }

            int cost = KruskalMinimumSpanningTree.getMonitoringCost(edges, junctions);
    ...
    private static class KruskalMinimumSpanningTree {
        ...
        private static int getMonitoringCost(List<Edge> edges, int totalVertices) {
            int cost = 0;
