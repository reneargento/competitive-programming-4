...
public class ForestsUVa {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int t = 0; t < tests; t++) {
            ...
            int trees = Integer.parseInt(data[1]);
            boolean[][] treesHeardPerPersonUnique = new boolean[people][trees + 1];
            ...
            while (line != null && !line.isEmpty()) {
                ...
                if (!treesHeardPerPersonUnique[person][tree]) {
                    treesHeardPerPerson[person].add(tree);
                    treesHeardPerPersonUnique[person][tree] = true;
                }
