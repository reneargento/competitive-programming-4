...
public class VirtualFriends {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int t = 0; t < tests; t++) {
            ...
            UnionFind unionFind = new UnionFind(friendships * 2);

            for (int i = 0; i < friendships; i++) {
                int person1 = getId(FastReader.next(), nameToIdMap);
                int person2 = getId(FastReader.next(), nameToIdMap);
                unionFind.union(person1, person2);
                outputWriter.printLine(unionFind.size(person1));
            }
        }
        outputWriter.flush();
    }

    private static int getId(String name, Map<String, Integer> nameToIdMap) {
