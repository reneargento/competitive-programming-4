...
public class Exercise3_FenwickTreeRangeMaxQuery {
    ...
    private static class FenwickTree {
        ...
        // Returns the maximum value from 1 to index
        public long rangeMaxQuery(int index) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("RangeMax 1: " + fenwickTree.rangeMaxQuery(1) + " Expected: 9");
        System.out.println("RangeMax 5: " + fenwickTree.rangeMaxQuery(5) + " Expected: 10");
        System.out.println("RangeMax 7: " + fenwickTree.rangeMaxQuery(7) + " Expected: 100");

        fenwickTree.update(5, 15);
        System.out.println("RangeMax 6: " + fenwickTree.rangeMaxQuery(6) + " Expected: 15");
        fenwickTree.update(2, 50);
        System.out.println("RangeMax 6: " + fenwickTree.rangeMaxQuery(6) + " Expected: 50");
        System.out.println("RangeMax 7: " + fenwickTree.rangeMaxQuery(7) + " Expected: 100");
    }
}
