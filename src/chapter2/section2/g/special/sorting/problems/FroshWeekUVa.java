 ...
 */
public class FroshWeekUVa {

    public static void main(String[] args) throws IOException {
        FastReader.init();
        String sequenceLengthLine = FastReader.getLine();

        while (sequenceLengthLine != null) {
            int sequenceLength = Integer.parseInt(sequenceLengthLine);
            ...
            sequenceLengthLine = FastReader.getLine();
        }
    }
